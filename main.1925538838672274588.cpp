...
void clean_chaos_first_row_with_balls () {
    while (!in_front_of_wall()) {
        if (on_ball()){
            get_ball();
}        else
...
void clean_one_row_and_step_down() {
    while (on_ball()) {
        get_ball();
        step();
    }
...
{
   clean_chaos_first_row_with_balls();
   turn_right();
   step();
   turn_right();
   while (on_ball()) {
      clean_one_row_and_step_down();
   }
   walk_towards_wall();
   turn_right();
   walk_towards_wall();
