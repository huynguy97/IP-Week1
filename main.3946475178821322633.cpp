...
//                                                                            
void get_balls_and_go_forward_until_wall()
{
    while(!in_front_of_wall()) {
        get_ball();
        step();
...
//                                                                 
void go_forward_until_ball_or_wall()
{
...
//                                                                                    
void get_balls_and_go_forward_until_no_ball()
{
    while(on_ball())
    {
        get_ball();
...
{
    get_balls_and_go_forward_until_wall(); //                      
    turn_right();
    if (on_ball()) clean_string_with_balls(); //     
}
...
void clean_chaos_with_balls ()
{
    ...
    if (on_ball()) //                            
    {
        ...
        {
            turn_right(); //             
            get_balls_and_go_forward_until_no_ball();
            turn_left(); //              
            step(); //               
            if (on_ball())
            { //                                                
                turn_right(); //             
                go_forward_until_no_ball();
                turn_right();
                turn_right(); //             
