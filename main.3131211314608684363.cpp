...
//                                                                                       
void clean_ball_if_not_in_front_of_wall ()
{
    while (on_ball()&&!in_front_of_wall())
    {
        get_ball();
...
//                                                                                
void let_charles_find_the_ball_and_move_to_the_block ()
{
    sweep_lane();
    get_ball();
    turn_right();
...
//                                                                                   
void place_ball_next_to_the_wall ()
{
    turn_right();
    while (in_front_of_wall())
       {
...
{
    while (on_ball())
        clean_ball_if_not_in_front_of_wall();
}
...
void clean_chaos_with_balls ()
{
    sweep_lane();
    while (on_ball()&&!in_front_of_wall())
        clean_first_row_of_balls();
        get_ball();
        go_down_east_if_not_on_ball();
    while (on_ball())
        clean_lane_with_balls();
        turn_left();
        sweep_lane();
        turn_right();
        sweep_lane();
...
{
    let_charles_find_the_ball_and_move_to_the_block();
    place_ball_next_to_the_wall();
    put_ball();
    step();
    place_ball_next_to_the_wall();
    put_ball();
