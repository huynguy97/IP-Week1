...
{
     (1,1,WORLDHEIGHT-3,false) ;
     (WORLDWIDTH-2,1,WORLDHEIGHT-3,false) ;
     (1,1,WORLDWIDTH-3,true) ;
     (1,WORLDHEIGHT-2,WORLDWIDTH-3,true) ;
}
...
void make_chaos_with_balls ()
{
    ...
    for (int lane = WORLDHEIGHT-2; lane > BOTTOM_LANE; lane--)
    {
        const int NO_OF_BALLS = rand () % (WORLDWIDTH/2) + 3 ;
         (WORLDWIDTH-NO_OF_BALLS-2,lane,NO_OF_BALLS,true) ;
    }
}
...
//                                                                                                                          
//                                                                                                                                                   
void sweep_lane_and_clear_balls(){
