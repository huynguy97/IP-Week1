...
void pickup_stop_at_end_of_balls()
{
    //                                                
    while (on_ball())
    {
...
void go_down_and_flip_at_right_wall()
{
    //                                       
    //                                  
    if (in_front_of_wall())
...
void walk_to_wall_picking_up_balls()
{
    //                                                       
    while (!in_front_of_wall())
    {
...
void go_to_next_row()
{
    ...
    go_down_and_flip_at_right_wall();
}

void clean_row()
{
    //                                                                                                      
    pickup_stop_at_end_of_balls();
    flip();
    go_to_next_row();
}
