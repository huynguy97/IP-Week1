...
//                                                      
//                            
void go_east_cleaning_up_chaos_with_balls()
{
    while (!on_ball() && !in_front_of_wall())
        step();
...
//                                                      
//                            
void go_west_cleaning_up_chaos_with_balls()
{
    if (!on_ball())
        turn_around();
    else {
...
{
    while (!in_front_of_wall()) {
        go_east_cleaning_up_chaos_with_balls();
        if (!in_front_of_wall()) {
            step();
            turn_right();
            go_west_cleaning_up_chaos_with_balls();
            if (!in_front_of_wall()) {
                step();
                turn_left();
            }
