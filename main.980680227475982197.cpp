...
int WINAPI WinMain (HINSTANCE hInstance, HINSTANCE hPrevInstance, PSTR szCmdLine, int iCmdShow)
{
	...
	sn_menu.add ((char*)"Wahed snel", quick)
		   .add ((char*)"Normaal",normal)
		   .add ((char*)"Slak",slow)
		   .add ((char*)"SUPER SLAK",very_slow);
