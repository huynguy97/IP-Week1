...
//                                                             
void walk_to_wall_whilst_getting_balls()
{
    while(!in_front_of_wall()){
        if(on_ball()){
            get_ball();
...
//                                                 
void clean_balls_and_walk_back ()
{
    clean_line_of_balls();
    turn_around();
    walk_to_wall();
...
{
    walk_to_wall_whilst_getting_balls();
    step_south();
    while(on_ball()){
        clean_balls_and_walk_back();
        step_south();
    }
...
//                                         
void place_balls_around_rectangle()
{
    for(int i = 0; i < 4; i++){
        place_balls_allong_wall();
        put_ball();
        turn_right();
        step();
    }
