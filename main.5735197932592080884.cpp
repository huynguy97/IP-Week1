...
{
    boolean facing_east = true; //                                                    
    //                                                                            
    boolean cleaning_up_balls = true; //                                                                                 

    while(cleaning_up_balls) //                                                      
    {
        if(!in_front_of_wall()) //                                                              
        {
            //                                                                                       
    ...
    boolean is_returning_first_half = true;
    boolean is_returning_second_half = false;
    //                                                                                             
    //                                                                                                                                                 

    while(is_returning_first_half || is_returning_second_half) //                                             
    {
        if(!in_front_of_wall()) //                                      
        {
            step();
        ...
        else
        {
            ...
            if(is_returning_first_half)
            {
                is_returning_first_half = false;
                is_returning_second_half = true;
                //                                                       
            }
            else
            {
                is_returning_second_half = false;
                //                                                                                  
            }
        }
    }
